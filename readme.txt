=== EM Dashboard ===
Contributors: Cybr
Tags: easy, mode, dashboard, theme, menu, metabox, meta, box, layout, admin, superadmin, multisite, users, rtl, color, scheme
...
WordPress can be quite overwhelming at times, the Easy Mode button resolves that with one click.
